...
import { API_DELETE_AWARD} from "../../../../../../config/WebService";
import ApiSauce from "../../../../../../services/ApiSauce";


export default function Awards({ data, slug }) {
  ...
  return (
    <View style={{ flex: 1 }}>
      <CustomSwipeListView
           ...
           Alert.alert(
            ...
            [
              ...
              { onDelete(data.item);
               ...
               ApiSauce.delete(API_DELETE_AWARD +"/"+data.item.id)
                .then((res) => {
                   console.log(res);
        ...
        onEdit={(data) => {
          const { item } = data;
          navigation.navigate("AddAwards", { ...item, slug: slug });
        }}
        renderListItem={(item) => {
          return <RenderAwards item={item} />;
        }}
      ></CustomSwipeListView>
    </View>
  );
