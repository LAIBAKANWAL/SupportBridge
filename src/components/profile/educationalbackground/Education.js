...
import { API_DELETE_INDIVISUAL_EDUCATION} from "../../../../../../config/WebService";
import ApiSauce from "../../../../../../services/ApiSauce";


export default function Education({ data, slug }) {
  ...
  return (
    <View style={{ flex: 1 }}>
      <CustomSwipeListView
           ...
           Alert.alert(
            ...
            [
              ...
              { onDelete(data.item);
               ...
               ApiSauce.delete(API_DELETE_INDIVISUAL_EDUCATION +"/"+data.item.id)
                .then((res) => {
                   console.log(res);
        ...
        onEdit={(data) => {
          const { item } = data;
          navigation.navigate("AddEducation", { ...item, slug: slug });
        }}
        renderListItem={(item) => {
          return <RenderEducation item={item} />;
        }}
      ></CustomSwipeListView>
    </View>
  );
