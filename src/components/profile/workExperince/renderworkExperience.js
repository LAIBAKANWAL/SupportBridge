...
const RenderworkExperience = React.memo(({ item }) => {
  return (
...
<View style={{ flexDirection: "row", flex: 1 }}>
                ...
                <View style={{ }}>
                 ...
                 style={{color: "#000", fontSize: 14, fontWeight: "400"}}
                  ...
                  <Text
                 style={{color: COLORS.primary, fontSize: 14, fontWeight: "400"}}
                  >
                    {item?.address}
                  </Text>
                  ...
                  {/* <Text style={styles.date}>{`${item.from} - ${
                    _.isNil(_.get(item, "to")) ? "present" : item.to
                  }`}</Text> */}
                </View>
...
const styles = StyleSheet.create({
  ...
  date: { color: "#808080", fontSize: 12, marginTop: 3 },
