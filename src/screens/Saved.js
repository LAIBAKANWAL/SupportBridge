    ...
    <SafeAreaView style={{ flex: 1, backgroundColor: COLORS.white }}>
      ...
      <ScrollView showsHorizontalScrollIndicator={false} style={{ marginHorizontal: SIZES.xSmall - 4 }}>
        ...
        <View style={{ marginHorizontal: SIZES.xSmall - 8 }}>
          <Card horizontal={false} hideContainer={true} showHeartIcon={true} list={filteredList} searchView={false} disablePress={false} showOrganiserInfo={false} showSavedIcon={true} showDonationInfo={true} savedView={true} imageView={true} profileView={false} viewRequest={false} />
